...
import {
  ...
  FlatList, StyleSheet, Alert, AsyncStorage,
} from 'react-native';
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.hint}>
        These people will receive an SMS with your GPS location when SOS is triggered.
      </Text>
...
const styles = StyleSheet.create({
  ...
  form: { backgroundColor: '#242424', borderRadius: 14, padding: 16, marginBottom: 24, borderWidth: 1, borderColor: '#333' },
  input: {
    backgroundColor: '#1a1a1a', color: '#fff', padding: 12, borderRadius: 8,
    marginBottom: 10, fontSize: 15, borderWidth: 1, borderColor: '#444',
  },
  addBtn: { backgroundColor: '#D32F2F', padding: 13, borderRadius: 8, alignItems: 'center' },
  addBtnText: { color: '#fff', fontWeight: '700', fontSize: 15 },
  empty: { color: '#555', textAlign: 'center', marginTop: 40, fontSize: 14 },
  contactRow: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: '#242424', padding: 14, borderRadius: 12,
    marginBottom: 10, borderWidth: 1, borderColor: '#333',
  },
  avatar: {
    width: 42, height: 42, borderRadius: 21,
    backgroundColor: '#D32F2F', alignItems: 'center', justifyContent: 'center', marginRight: 12,
  },

...
import { View, Text, Switch, TextInput, StyleSheet, TouchableOpacity, Alert } from 'react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.cardDesc}>
          Default emergency number for one-tap calling. India: 112, US: 911, UK: 999.
        </Text>
        <TextInput
          style={styles.input}
...
const styles = StyleSheet.create({
  ...
  card: {
    backgroundColor: '#242424', borderRadius: 14, padding: 16,
  ...
  input: {
    ...
    borderRadius: 8, fontSize: 15, borderWidth: 1, borderColor: '#444',
  },
  saveBtn: {
    backgroundColor: '#D32F2F', padding: 16,
